...
const SingleGame = ({
	...
	return (
		...
		<div className="flex flex-col  bg-slate-800 text-slate-200 rounded-full items-center w-100 h-70 p-8 pt-6 pb-8 mt-6 mb-6 hover:border-4 border-sky-400 hover:shadow-2xl hover:shadow-sky-300 opacity-85 hover:opacity-100">
